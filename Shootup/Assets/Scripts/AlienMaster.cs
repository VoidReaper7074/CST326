...
public class AlienMaster : MonoBehaviour
{
    ...
    private Vector3 hMoveDistance = new Vector3(0.4f, 0, 0);
    private Vector3 vMoveDistance = new Vector3(0, 0.15f, 0);
    private Vector3 motherShipSpawnPos = new Vector3(15f, 4f, 0);

    private const float Max_Right = 8.62f;
    private const float Max_Left = -8.62f;
    private const float Max_Move_Speed = 0.09f;
